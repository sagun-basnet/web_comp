...
<body>
    <div class="wrapper">
        <form class="form-signin" action="#" method="POST">
            ...
            <button class="btn btn-lg btn-primary btn-block mt-4" type="submit" name="submit">Register</button>
            <p class="mt-4 text-lowercase">already register?<a href="login.php">click here</a></p>
        </form>
    </div>
    <!-- Bootstrap JS -->
